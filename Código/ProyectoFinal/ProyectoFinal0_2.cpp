...
int main()
{
	...
	/*ModelAnim holograma("resources/objects/hologramacompleto/hologram.dae");
	holograma.initShaders(animShader.ID);*/
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Personaje
		// -------------------------------------------------------------------------------------------------------------------------
		model = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, -22.0f, 0.0f));
