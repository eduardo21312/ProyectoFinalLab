...
int main()
{
	...
	// load models
	// -----------
	Model piso("resources/objects/piso2/pisoarena.obj");
	...
	Model Cabeza("resources/objects/Cabeza R2D2/Cabeza Color 2.obj");
	...
	KeyFrame[0].movCuerpo = 0.0f;
	KeyFrame[0].movCabeza = 0.0f;
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::translate(glm::mat4(1.0f), glm::vec3(30.0f, -8.0f, 40.0f));
		...
		model = glm::translate(glm::mat4(1.0f), glm::vec3(-355.0f, -23.0f, -415.0f));
		...
		model = glm::translate(glm::mat4(1.0f), glm::vec3(420.0f, -23.0f, 350.0f));
		model = glm::rotate(model, glm::radians(45.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(4.5f));
		staticShader.setMat4("model", model);
		CasaT.Draw(staticShader);

		model = glm::translate(glm::mat4(1.0f), glm::vec3(400.0f, -23.0f, -415.0f));
		...
		// Personaje
		// -------------------------------------------------------------------------------------------------------------------------
		model = glm::translate(glm::mat4(1.0f), glm::vec3(0, -22.0f, 0));
		model = glm::translate(model, glm::vec3(posX, posY, posZ));
		tmp = model = glm::rotate(model, glm::radians(giroR2D2), glm::vec3(1.0f, 0.0f, 0.0));
		...
		model = glm::rotate(model, glm::radians(0.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::rotate(model, glm::radians(movPataCh), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(3.5f));
		staticShader.setMat4("model", model);
		Patachica.Draw(staticShader);

		//Cabeza
		model = glm::translate(tmp, glm::vec3(-0.8f, -9.0f, -3.0f));
